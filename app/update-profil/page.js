                ...
                <form className="bg-gray-800 shadow-lg rounded-2xl p-6">
                    ...
                    <div className="mt-14 px-4">
                        ...
                        <div className="flex flex-col relative">
                            <label for="username" className="hidden">Modifier le nom d'utilisateur:</label>
                            <input type="text" name="username" id="username" placeholder="nom à récupérer en base de données"className="bg-gray-800 border-2 border-gray-700 w-96 rounded-md focus:outline-none focus:ring-2 focus:ring-[#16DB65] text-[#ececec] px-2"/>
                    ...
                    <div className="flex flex-col relative">
                        <label for="username" className="hidden">Modifier la description:</label>
