        ...
        <>
            <form className="max-w-md mx-auto">   
                ...
                <div className="relative">
                    <input type="search" id="default-search" className="block w-full py-4 ps-4 text-sm text-[#ececec] border-2 border-[#16DB65] rounded-full bg-[#181818] focus:bg-[#1f1f1f] focus:ring-[#16DB65] focus:outline-none focus:ring-2" placeholder="Rechercher" required />
